...
public class SongArrayAdapter extends ArrayAdapter<Song> {
    ...
    TextView tvTitle, tvYear, tvSingerName;
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        tvTitle = (TextView) rowView.findViewById(R.id.tvSongTitle);
        tvYear = (TextView) rowView.findViewById(R.id.tvYear);
        tvSingerName = (TextView) rowView.findViewById(R.id.tvSingerName);
        ...
        tvSingerName.setText(song.getSingers());
